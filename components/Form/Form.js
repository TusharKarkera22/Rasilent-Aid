...
const Form = () => {
  ...
  return (
      <FormState.Provider value={{form, setForm, image, setImage, ImageHandler, FormHandler, setImageUrl, setStoryUrl, startCampaign, setUploaded}} >
        ...
        <p className='font-iowan text-[20px] text-black my-4'>Create Campaigns</p>
    <FormWrapper className='flex justify-center w-[1120px] h-[740px] bg-[#C2E866]'>
        <FormMain className=' flex flex-col place-content-center ' >
            {loading == true ?
                ...
                <Address className='mt-20% justify-center flex flex-col '>
                    ...
                    <h1 className='font-iowan text-[16px] uppercase place-content-center translate-[10%] '>Campagin Started Sucessfully!</h1>

                    <h1 className=' mt-2 font-iowan text-[16px] text-green place-content-center ' >{address}</h1>
        ...
        inline-flex items-center  space-x-2 text-green hover:img hover:text-primary-black border
         border-green hover:bg-green  px-2 py-2.5 text-sm focus:outline-none focus:ring-green-300 font-iowan 
